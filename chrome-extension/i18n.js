...
(function (g) {
  ...
  const MESSAGES = {
    en: {
      ...
      type_imap: "Other mailboxes (IMAP)",
      imap_host: "IMAP server",
      imap_port: "Port",
      imap_secure: "SSL/TLS",
      imap_username: "Login username (usually the full email address)",
      imap_password: "Client authorization code / app password",
      imap_help: "163: imap.163.com; 126: imap.126.com; yeah.net: imap.yeah.net. Use port 993 with SSL/TLS. Enter a client authorization code or app password, not your webmail password.",
      ...
      invalid_base_url: "Enter a valid Agent URL beginning with http:// or https://.",
      clear: "Clear",
    ...
    zh: {
      ...
      imap_port: "端口",
      imap_secure: "SSL/TLS",
      imap_username: "登录用户名（通常为完整邮箱）",
      imap_password: "客户端授权码 / 应用专用密码",
      imap_help: "163：imap.163.com；126：imap.126.com；yeah.net：imap.yeah.net。端口均为 993，并开启 SSL/TLS。请使用邮箱后台生成的客户端授权码或应用专用密码，不要填写网页登录密码。",
      type_outlook_oauth: "Outlook（OAuth）",
      remove_account: "删除",
      removing: "删除中…",
      ...
      invalid_base_url: "请输入以 http:// 或 https:// 开头的有效 Agent 地址。",
      clear: "清除",
      disconnect: "断开连接",
      clearing: "清除中…",
      cleared: "已清除。",
